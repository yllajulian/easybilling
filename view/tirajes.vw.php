            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row-reverse mb-2">
                           <button type="button" class="btn btn-success btn-md" onclick="openTiraje('nuevo')"><i class="bx bx-plus icon-database-add"></i>  Agregar Nuevo/a</button>
                    </div>
          ...
          <div class="modal-body">
                        ...
                        <div class="row"> 
                            <div class="col-lg-6">
                                ...
                                <select id="cbCompro" name="cbCompro" class="form-select select2 p-4"></select>
                                </div>   
                            </div>   
                            <div class="col-lg-6">
                                <div class="form-group">
                                <label for="" class="col-form-label"> Fecha y Hora Tiraje * </label>
                                <div class="input-group  mb-3"><span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
                                  <input class="form-control" type="text" id="txtFechaT" name="txtFechaT" placeholder="" />
                                </div>           
                                </div>               
                            </div>
                        </div>
                        ...
                        <div class="row"> 
                            <div class="col-lg-6">
                                <div class="form-group">
                                <label for="" class="col-form-label"> Numero Resolucion * </label>
                                <input type="text" class="form-control" id="txtNoResolucion" name="txtNoResolucion">
                                </div>   
                            </div>   
                            <div class="col-lg-6">
                                <div class="form-group">
                                <label for="" class="col-form-label"> Serie *  </label>
                                <input type="text" class="form-control" id="txtNoSerie" name="txtNoSerie">
                                </div>               
                            </div>
                        </div>
                        ...
                        <div class="row"> 
                            <div class="col-lg-6">
                                <div class="form-group">
                                <label for="" class="col-form-label">Del</label>
                                <input type="text" class="form-control" id="txtDel" name="txtDel">
                                </div>   
                            </div>   
                            <div class="col-lg-6">
                                <div class="form-group">
                                <label for="" class="col-form-label">Al</label>
                                <input type="text" class="form-control" id="txtAl" name="txtAl">
                                </div>               
                            </div>
                        </div>
                        <div class="row"> 
                            <div class="col-lg-6">
                                <div class="form-group">
                                <label for="" class="col-form-label">Disponibles</label>
                                <input type="text" class="form-control" id="txtDispo" name="txtDispo">
                                </div>   
                            </div>   
                            <div class="col-lg-6">
                                <div class="form-group">
                                <label for="" class="col-form-label">Utilizados</label>
                                <input type="text" class="form-control" id="txtUsados" name="txtUsados">
                                </div>               
                            </div>
                        </div>
...
<?php include_once'includes/footer.php';
    ...
    <script src="web/custom-js/tiraje.js" type="text/javascript"></script>
