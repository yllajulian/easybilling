            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-row-reverse mb-2">
                           <button type="button" class="btn btn-success btn-md" onclick="openComprobante('nuevo')"><i class="bx bx-plus icon-database-add"></i>  Agregar Nuevo/a</button>
                    </div>
         ...
         <form  name="formvalidate">    
          <div class="modal-body">
                        ...
                        <div class="row"> 
                            ...
                            <input type="text" class="form-control text-uppercase" id="txtComprobante" name="txtComprobante">
                            </div>               
                            </div>
                        </div>
                        <div class="row mt-3"> 
...
<?php include_once'includes/footer.php';
    ...
    <script src="web/custom-js/comprobante.js" type="text/javascript"></script>
  </body>
