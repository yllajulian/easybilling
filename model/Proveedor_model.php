<?php 
	...
	class ProveedorModel extends Conexion
	{
		...
		$nombre_contacto, $telefono_contacto)
		{
			...
			try 
			{
				$query = "CALL sp_insert_proveedor(:nombre_proveedor, :numero_telefono, :numero_nit, :numero_nrc, 
				:nombre_contacto, :telefono_contacto)";
				$stmt = $dbconec->prepare($query);
		...
		$nombre_contacto, $telefono_contacto,$estado)
		{
			...
			try 
			{
				$query = "CALL sp_update_proveedor(:idproveedor, :nombre_proveedor, :numero_telefono, :numero_nit, :numero_nrc, 
				:nombre_contacto, :telefono_contacto, :estado);";
				$stmt = $dbconec->prepare($query);
