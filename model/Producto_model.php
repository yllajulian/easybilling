<?php
	...
	class ProductoModel extends Conexion
	{
		...
		public  static function Listar_Productos_SS($tabla,$where,$orderBy)
		{
			$dbconec = Conexion::Conectar();

			try
			{
				$query = "SELECT * FROM $tabla $where $orderBy";
				$stmt = $dbconec->prepare($query);
				$stmt->execute();
				$count = $stmt->rowCount();
		...
		public  static function Editar_Producto($idproducto, $codigo_barra,$nombre_producto,$precio_compra,$precio_venta,$precio_venta_mayoreo,$stock_min,
