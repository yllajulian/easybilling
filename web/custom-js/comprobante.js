            ...
            html += `<tr>
                ...
                html +=`<td>
                          <div class="btn-group dropleft">
                            ...
                            <button id="btnEditar" class="dropdown-item btn btn-warning" onclick="openComprobante('editar','${data.idcomprobante}','${data.nombre_comprobante}','${data.estado}')"><span class="fa fa-edit"></span> Modificar</button>
                            <button class='dropdown-item btn btn-danger' onclick="openComprobante('ver','${data.idcomprobante}','${data.nombre_comprobante}','${data.estado}')"><span class='fa fa-eye'></span> Ver</button>
                            </ul>
                          </div>
                          </td> 
                        </tr> `
...
function openComprobante(action, idcomprobante,nombre_comprobante,estado){
...
console.log(action);
    ...
    if (action == 'nuevo'){
            ...
            $(".modal-title").text("Registro Comprobante");
            ...
            $("#txtComprobante").val(nombre_comprobante);
          if (estado == '1')
            {
              $("#chkEstado").val(true);
              setSwitchery(mySwitch, true);
            ...
            $(".modal-title").text("Actualizar Comprobante");
            $('#modal_iconified').modal('show');
     } else if(action=='ver'){
...
//     $('#modal_iconified').modal('show');
//  }
// function openCategoria(action,idcomprobante,nombre,estado)
//  {
//       var mySwitch = new Switchery($('#chkEstado')[0], {
//           size:"small",
//           color: '#0D74E9'
...
//   var proceso = $("#txtProceso").val();
//   var id = $("#txtID").val();
//   var categoria =$("#txtComprobante").val();
//   var estado = $('#chkEstado').is(':checked') ? 1 : 0;
